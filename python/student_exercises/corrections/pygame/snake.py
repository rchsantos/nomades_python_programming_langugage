...
class Snake:
    ...
    ********************************************************************************************************************
    ...
    def __init__(self, color) -> None:
        ...
        """
        # Initialize the position of the snake with a random position.
        head: Point = Point.get_random_point(WIDTH, HEIGHT)
        while head.x < 2*BLOCK_SIZE:
          head = Point.get_random_point(WIDTH, HEIGHT)
        
        # Initialize the snake with 3 segments. the segments are stored in the self.body attribute.
        ...
        # Initialize the direction of the snake with a random direction. (UP, DOWN, RIGHT)
    ...
    def change_direction(self, direction: str) -> None:
        ...
        """
        # if (
        #   self._current_direction == "DOWN" and direction == "UP"
    ...
    def check_self_collision(self) -> bool:
        ...
        """
        return self.body[0] in self.body[4:]
    ...
    def draw(self) -> None:
        for segment in self.body:
            pygame.draw.rect(screen, self.color, (segment.x, segment.y, BLOCK_SIZE, BLOCK_SIZE))
